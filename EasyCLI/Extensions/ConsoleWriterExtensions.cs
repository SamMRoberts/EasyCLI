namespace EasyCLI.Extensions
{
    ...
    public static class ConsoleWriterExtensions
    {
        ...
        public static void WriteSuccess(this Console.IConsoleWriter w, string message, ConsoleTheme? theme = null)
        {
        ...
        /// <param name="message">The message to write.</param>
        /// <param name="theme">The theme to use for styling. If null, uses the default theme.</param>
        public static void WriteWarning(this Console.IConsoleWriter w, string message, ConsoleTheme? theme = null)
        {
            ArgumentNullException.ThrowIfNull(w);
        ...
        /// <param name="message">The message to write.</param>
        /// <param name="theme">The theme to use for styling. If null, uses the default theme.</param>
        public static void WriteError(this Console.IConsoleWriter w, string message, ConsoleTheme? theme = null)
        {
            ArgumentNullException.ThrowIfNull(w);
        ...
        /// <param name="message">The message to write.</param>
        /// <param name="theme">The theme to use for styling. If null, uses the default theme.</param>
        public static void WriteHeading(this Console.IConsoleWriter w, string message, ConsoleTheme? theme = null)
        {
            ArgumentNullException.ThrowIfNull(w);
        ...
        /// <param name="message">The message to write.</param>
        /// <param name="theme">The theme to use for styling. If null, uses the default theme.</param>
        public static void WriteInfo(this Console.IConsoleWriter w, string message, ConsoleTheme? theme = null)
        {
            ArgumentNullException.ThrowIfNull(w);
        ...
        /// <param name="message">The message to write.</param>
        /// <param name="theme">The theme to use for styling. If null, uses the default theme.</param>
        public static void WriteHint(this Console.IConsoleWriter w, string message, ConsoleTheme? theme = null)
        {
            ArgumentNullException.ThrowIfNull(w);
        ...
        /// <param name="message">The message to write.</param>
        /// <param name="theme">The theme to use for styling. If null, uses the default theme.</param>
        public static void WriteSuccessLine(this Console.IConsoleWriter w, string message, ConsoleTheme? theme = null)
        {
            ArgumentNullException.ThrowIfNull(w);
        ...
        /// <param name="message">The message to write.</param>
        /// <param name="theme">The theme to use for styling. If null, uses the default theme.</param>
        public static void WriteWarningLine(this Console.IConsoleWriter w, string message, ConsoleTheme? theme = null)
        {
            ArgumentNullException.ThrowIfNull(w);
        ...
        /// <param name="message">The message to write.</param>
        /// <param name="theme">The theme to use for styling. If null, uses the default theme.</param>
        public static void WriteErrorLine(this Console.IConsoleWriter w, string message, ConsoleTheme? theme = null)
        {
            ArgumentNullException.ThrowIfNull(w);
        ...
        /// <param name="message">The message to write.</param>
        /// <param name="theme">The theme to use for styling. If null, uses the default theme.</param>
        public static void WriteHeadingLine(this Console.IConsoleWriter w, string message, ConsoleTheme? theme = null)
        {
            ArgumentNullException.ThrowIfNull(w);
        ...
        /// <param name="message">The message to write.</param>
        /// <param name="theme">The theme to use for styling. If null, uses the default theme.</param>
        public static void WriteInfoLine(this Console.IConsoleWriter w, string message, ConsoleTheme? theme = null)
        {
            ArgumentNullException.ThrowIfNull(w);
        ...
        /// <param name="message">The message to write.</param>
        /// <param name="theme">The theme to use for styling. If null, uses the default theme.</param>
        public static void WriteHintLine(this Console.IConsoleWriter w, string message, ConsoleTheme? theme = null)
        {
            ArgumentNullException.ThrowIfNull(w);
