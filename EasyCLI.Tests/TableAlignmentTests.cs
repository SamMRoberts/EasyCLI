...
namespace EasyCLI.Tests
{
    public class TableAlignmentTests
    {
        ...
        public void BuildSimpleTable_RespectsAlignmentAndMaxWidth()
        {
            ...
            var lines = new List<string>(EasyCLI.ConsoleFormatting.BuildSimpleTable(
                headers,
                rows,
                padding: 1,
                maxWidth: 40,
                alignments: new[] { EasyCLI.ConsoleFormatting.CellAlign.Left, EasyCLI.ConsoleFormatting.CellAlign.Center, EasyCLI.ConsoleFormatting.CellAlign.Right }));
